...
public:
    ...
    /*!
     * @brief Reinvirtueller Destruktor (Verhindert das Instanzieren eines Medium-Objekts)
     */
     ...
     * virtual, damit die Funktion durch die Subklassen überladen werden kann
     */
    ...
    /*
     * @brief Gibt den Status des Mediums wieder
